...
-- For now, we'll allow all operations for simplicity, but in production you'd want proper auth
...
-- Enable RLS (Row Level Security) - for production you'd add proper policies
...
CREATE POLICY "Allow all operations for now" ON scenario_multipliers FOR ALL USING (true);
CREATE POLICY "Allow all operations for now" ON base_assumptions FOR ALL USING (true);
CREATE POLICY "Allow all operations for now" ON b2b_tiers FOR ALL USING (true);
CREATE POLICY "Allow all operations for now" ON b2b_clients FOR ALL USING (true);
CREATE POLICY "Allow all operations for now" ON b2b_pricing FOR ALL USING (true);
CREATE POLICY "Allow all operations for now" ON costs FOR ALL USING (true);
CREATE POLICY "Allow all operations for now" ON employee_roles FOR ALL USING (true);
